...
export const SearchControls = () => {
  ...
  //extraccion de datos url searchParams
  ...
  const handleKeyDown = (event: React.KeyboardEvent<HTMLInputElement>) => {
    console.log("KEY:", event.key); // 👈 prueba básica
    if (event.key === "Enter") {
    ...
    <>
      <div className="flex flex-col lg:flex-row gap-4 mb-8">
        ...
        <div className="flex gap-2">
          <Button
            variant={activeAccord === "advance-filters" ? "default" : "outline"}
            className="h-12 "
            onClick={() => {
              if (activeAccord === "advance-filters") {
                setSearchParams((prev) => {
