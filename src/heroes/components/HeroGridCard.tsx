...
export interface HeroGridCardProps {
  hero: Hero;
}
...
export const HeroGridCard = ({ hero }: HeroGridCardProps) => {
  ...
  const { isFavorite, toggleFavorite } = useFavoriteHero();
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-1">
              {
                // Mostrar solo las 3  primeras habilidades del héroe
              ...
              {
                // Si hay más de 3 habilidades, mostrar un badge adicional que con el cursor indique cuántas más hay
                hero.powers.length > 3 && (
                  <Badge
                    variant="outline"
                    className="text-xs cursor-pointer"
                    title={hero.powers.slice(3).join(", ")} // mostrar el resto de habilidades en el tooltip
                  >
